  ...
  return (
    <div>
      <main>
                  ...
                  <div class="go--back">
                    <Link to="/">
                      <a href="index.html" class="button">
                        <img
                          src="https://mysignal.netlify.app/assets/images/chevron-left.svg"
                          alt=""
                        />
                        <span>Go back</span>
                      </a>
        ...
        <section class="singlelife--registration singlefamily--registration single-i-family--registration">
          <div class="container">
            <div class="section--title">
              <h3>SIGNAL i-Life Registration</h3>
              <p>
                SIGNAL i-Life is a customised and affordable Takaful SIGNAL
                Plan, providing valuable Personal Accident benefits and
                Outpatient Clinical Reimbursement, paired with a SIM card with
                exceptional telco services
              </p>
            </div>
              ...
              <div class="col-md-11 mt-5">
                <div class="benefit--box">
                  ...
                  <form
                    ...
                    novalidate
                  >
                    <div class="benefit--tab--area mt-5">
                      <div class="accordion" id="accordionExample">
                          ...
                          <Accordion.Item eventKey="0">
                            ...
                            <Accordion.Body>
                              <div class="accordion-body">
                                <div class="insurance--features--table table1">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td
                                          ...
                                          class="feature"
                                        >
                                          Double indemnity on public occurrence
                                        </td>
                                        <td data-th="Upto" class="upto">
                                          Up to
                                        </td>
                                      ...
                                      <tr>
                                        <td
                                          ...
                                          class="feature"
                                        >
                                          Dengue fever, Malaria or Japanese
                                          Encephalitis
                                        </td>
                                        <td data-th="Upto" class="upto">
                                          Up to
                                      ...
                                      <tr>
                                        <td
                                          ...
                                          class="feature"
                                        >
                                          Death due to specified illness e.g.
                                          Dengue
                                        </td>
                                        <td data-th="Upto" class="upto"></td>
                                        <td data-th="RM" class="rm">
                                      ...
                                      <tr>
                                        <td
                                          ...
                                          class="feature"
                                        >
                                          Prosthesis/Wheelchair - permanent
                                          total disablement
                                        </td>
                                        <td data-th="Upto" class="upto">
                                          Up to
                                      ...
                                      <tr>
                                        <td
                                          ...
                                          class="feature"
                                        >
                                          Dental correction or corrective
                                          cosmetic surgery
                                        </td>
                                        <td data-th="Upto" class="upto"></td>
                                        <td data-th="RM" class="rm">
                                      ...
                                      <tr>
                                        <td
                                          ...
                                          class="feature"
                                        >
                                          Loss of personal effects due to snatch
                                          theft
                                        </td>
                                        <td data-th="Upto" class="upto">
                                          Up to
                                      ...
                                      <tr>
                                        <td class="feature">
                                          <a href="#">
                                            …and more (please refer to policy
                                            for full list of benefits)
                                          </a>
                                        </td>
                                      </tr>
                                    </tbody>
                        ...
                        <div class="accordion-item telco item2">
                          <Accordion>
                            <Accordion.Item eventKey="0">
                              <Accordion.Header>
                                <div class="benefit--accordion--title--wrapper">
                              ...
                              <Accordion.Body>
                                <div class="accordion-body">
                                  <table class="insurance-table insurance-tablev2">
                                    <tbody>
                                      <tr>
                                        <th class="big--heading"></th>
                                        <th class="rm--heading">DIGI</th>
                                        <th class="rm--heading">U Mobile</th>
                                      </tr>
                                      <tr>
                        ...
                        <div class="accordion-item telco item3">
                          <Accordion>
                            <Accordion.Item eventKey="0">
                              <Accordion.Header>
                                <div class="benefit--accordion--title--wrapper">
                    ...
                    <div class="eligibility--box--wrapper mt-5">
									...
									<div class="eligibility--box radio--box--default card--default row">
										<div class="adult--select--box col-12 col-sm-12 col-md-12 col-lg-6 mx-auto">
											...
											<div class="input--group">
												<input type="radio" id="adult-yes" name="adult-check-group"
													value="adult-yes" checked/>
												<label for="adult-yes">Yes</label>
											</div>
											<div class="input--group">
												<input type="radio" id="adult-no" name="adult-check-group"
													value="adult-no"/>
										...
										<div class="nationality--select--box col-12 col-sm-12 col-md-12 col-lg-6 mx-auto">
											...
											<div class="input--group">
												<input type="radio" id="non-malaysian" name="nationality--group"
													value="2"/>
												<label for="non-malaysian">Non-Malaysian (legally residing, studying or
													working in Malaysia)</label>
											</div>
										</div>
									</div>
								</div>
								<div class="eligibility--hidden--items">
										...
										<div class="plan--box card--default">
											...
											<div class="select--purchase plan--box mt-5">
												<div class="select--plan">
													...
													<div class="plan--option">
														<div class="input--group">
															<input type="radio" id="purchase1" value="purchase1"
																name="purchase--group"/>
															<label for="purchase1">
																<p>Register for new Mobile Number and Plan (with new SIM
																	card)</p>
															</label>
														</div>
														<div class="input--group">
															<input type="radio" id="purchase2" value="purchase2"
																name="purchase--group" checked/>
															<label for="purchase2">
																<p>Maintain and port existing Mobile Number (from any
																	telco service providers excluding <sapn
																		class="change--telco--text">DIGI</sapn>) to new
																	Plan</p>
															</label>
														</div>
														<div class="input--group">
															<input type="radio" id="purchase3" value="purchase3"
																name="purchase--group"/>
															<label for="purchase3">
																<p>Maintain existing Mobile Number (from any telco
																	service providers excluding <sapn
																		class="change--telco--text">DIGI</sapn>) and
																	register for new Plan (with existing SIM card)</p>
															</label>
														</div>
													</div>
												</div>
											...
											<div class="row">
												<div class="col-lg-6">
													<div class="form--malaysian personal--info--box">
														<h4>Malaysian</h4>
														<div class="input--group">
															<input class="form-control" type="text" name="m-full-name"
																id="m-full-name" placeholder="Fullname as per NRIC"
																required/>
															<div class="invalid-feedback">Full Name is required</div>
														</div>
														<div class="input--group">
															<input class="form-control" type="text" name="m-nric-number"
																id="m-nric-number" placeholder="NRIC Number" required/>
															<div class="invalid-feedback">NRIC Number is required</div>
														</div>
														<div class="input--group">
															<input class="form-control" type="text"
																name="m-mobile-number" id="m-mobile-number"
																placeholder="Mobile Number [with prefix +601]" required/>
															<div class="invalid-feedback">Mobile Number is required
															</div>
														</div>
														<div class="input--group">
															<input class="form-control" type="email" name="m-email"
																id="m-email" placeholder="Email" required/>
															<div class="invalid-feedback">Email is required</div>
														</div>
														<div class="input--group">
															<input class="form-control" type="text" name="m-address"
																id="m-address" placeholder="Correspondence Address"
																required/>
														...
														<div class="input--group select--box">
															<select class="form-select" id="state" name="state"
																required>
																<option value="1" selected>Perlis</option>
														...
														<div class="input--group">
															<input class="form-control" type="text" name="m-postcode"
																id="m-postcode" placeholder="Postcode" required/>
															<div class="invalid-feedback">Postcode is required</div>
														</div>

														<div class="input--group user-alt-location">
															<input type="checkbox" class="mt-0 form-check"
																name="m-location" id="m-locationCheck"/>
															<label for="m-locationCheck">Clock here if your Location of
																Risk is the same as correspondence address.</label>
														</div>

														<div class="input--group">
															<input class="form-control" type="text" name="m-location-field" id="m-location-field" placeholder="Location of Risk (to state accurately for Home Care Insurance claim)"required/>
														</div>
														<div class="input--group nric-upload upload--box mt-5">
															<input class="form-control" type="file" name="nric-upload"
																id="nric-upload" required/>
															<label for="nric-upload">
																<img src="assets/images/upload.svg" alt=""/>
																<p>Upload NRIC [front and back]</p>
																<span>Format PDF, JPEG or PNG and file size must not
																	exceed 500KB</span>
															</label>
														</div>
														<div class="input--group phone-bill-upload upload--box mt-5">
															<input class="form-control" type="file"
																name="phone-bill-upload" id="phone-bill-upload"
																required/>
															<label for="phone-bill-upload">
																<img src="assets/images/upload.svg" alt=""/>
																<p>Upload latest phone statement (first page only)
																</p>
																<span>Format PDF, JPEG or PNG and file size must not
																	exceed 500KB</span>
															</label>
												...
												<div class="col-lg-6">
													<div class="form--non-malaysian personal--info--box">
														<h4>Non-Malaysian</h4>
														<div class="input--group">
															<input class="form-control" type="text" name="nm-full-name"
																id="nm-full-name" placeholder="Fullname as per Passport"
																disabled required/>
															<div class="invalid-feedback">Full Name is required</div>
														</div>
														<div class="input--group">
															<input class="form-control" type="text"
																name="nm-pass-number" id="nm-pass-number"
																placeholder="Passport Number" disabled required/>
															<div class="invalid-feedback">Passport is required</div>
														</div>
														<div class="input--group">
															<input class="form-control" type="text"
																name="nm-mobile-number" id="nm-mobile-number"
																placeholder="Mobile Number [with prefix +601]" disabled
																required/>
															<div class="invalid-feedback">Mobile Number is required
															</div>
														</div>
														<div class="input--group">
															<input class="form-control" type="email" name="nm-email"
																id="nm-email" placeholder="Email" disabled required/>
															<div class="invalid-feedback">Email is required</div>
														</div>
														<div class="input--group">
															<input class="form-control" type="text" name="nm-address"
																id="nm-address" placeholder="Correspondence Address"
																disabled required/>
															<div class="invalid-feedback">Address is required</div>
														</div>
														<div class="input--group select--box">
														...
														<div class="input--group">
															<input class="form-control" type="text" name="nm-postcode"
																id="nm-postcode" placeholder="Postcode" disabled
																required/>
															<div class="invalid-feedback">Postcode is required</div>
														</div>
														...
														<div class="input--group user-alt-location">
															<input type="checkbox" class="mt-0 form-check"
																name="m-n-location" id="m-n-locationCheck" disabled/>
															<label for="m-n-locationCheck">Clock here if your Location
																of Risk is the same as correspondence address.</label>
														</div>

														<div class="input--group">
															<input class="form-control" type="text"
																name="m-location-field" id="m-n-location-field"
																placeholder="Location of Risk (to state accurately for Home Care Insurance claim)"
																required disabled/>
														</div>
														<div class="input--group nationality select--box">
															<select class="form-select" id="nationality"
																...
																<option value="91">Trinidad and Tobago</option>
															...
															<div class="invalid-feedback">Please select a Nationality
															</div>
														</div>
														<div class="input--group">
															<input class="form-control" type="date" name="nm-date"
																id="nm-date" placeholder="Date of birth [DD/MM/YYYY]"
																disabled required/>
															<div class="invalid-feedback">Date of birth is required
															</div>
														</div>
														<div class="input--group gender mt-5">
															...
															<div class="gender--option radio--box--default">
																<div class="input--group">
																	<input type="radio" id="male" name="gander--group"
																		disabled checked/>
																	<label for="male">
																		<p>Male</p>
																	</label>
																...
																<div class="input--group">
																	<input type="radio" id="female" name="gander--group"
																		disabled checked/>
																	<label for="female">
																		<p>Female</p>
																	</label>
														...
														<div class="input--group phone-bill-upload upload--box mt-5">
															<input type="file" class="form-control"
																name="phone-bill-upload" id="non-nirc-upload" required
																disabled/>
															<label for="non-nirc-upload">
																<img src="assets/images/upload.svg" alt=""/>
																<p>Upload Passport (page with personal details and
																	photo) </p>
																<span>Format PDF, JPEG or PNG and file size must not
																	exceed 500KB</span>
															</label>
														...
														<div class="input--group phone-bill-upload upload--box mt-5">
															<input type="file" class="form-control"
																name="phone-bill-upload" id="phone-bill-upload-non"
																required disabled/>
									...
									<div class="aggrement--box card--default mt-5">
										<div class="input--group">
											<input type="checkbox" name="marketing--aggrement"
												id="marketing--aggrement"/>
											<label for="marketing--aggrement">I hereby agree the registration and
												ownership of my mobile number will be held by MySignal Marketing Sdn Bhd
												(company registration no.: 201901003462 / 1312788-U).</label>
										</div>
										<div class="input--group mt-5">
											<input type="checkbox" name="terms--aggrement" id="terms--aggrement"/>
											<label for="terms--aggrement">I hereby agree and accept the governing Terms
												and Conditions and to be bound by the terms of the same and such
												additional terms as may be set out in the Policy and/or the certificate
												of insurance issued for SIGNAL plan.</label>
										</div>
									</div>
