        ...
        <section class="singlelife--registration singlegold--registration">
          <div class="container">
            <div class="section--title">
              <h3>SIGNAL Life Registration</h3>
              <p>
                SIGNAL Life is a customised and affordable SIGNAL programme,
                providing valuable Personal Accident Insurance, Home & Lifestyle
                Insurance and Outpatient Clinical Reimbursement, paired with a
                SIM card with exceptional telco services
              </p>
            </div>
                                  ...
                                  <table class="insurance-table insurance-tablev2">
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td data-th="DIGI" class="rm">
                                          Unlimited
                                        </td>
                                        <td data-th="U Mobile" class="rm">
                                          Unlimited
                                        </td>
                                      </tr>
                                      <tr>
                            ...
                            <Accordion.Item eventKey="0">
                              <Accordion.Header>
                                <div class="benefit--accordion--title--wrapper">
                                  ...
                                  <div class="single--life title--small">
                                    <p>SIGNAL Life & SIGNAL Life Plus</p>
                                  </div>
                                </div>
                              </Accordion.Header>
                              <Accordion.Body>
