        ...
        <section class="singlelife--registration singlegold--registration">
          <div class="container">
            <div class="section--title">
              <h3>SIGNAL Premier Registration</h3>
              <p>
                SIGNAL Premier is an exclusive SIGNAL Plan offering valuable
                protection encompassing Medical (Hospitalisation & Surgical),
                                  ...
                                  <div class="insurance--features--table">
                                    <div class="custom--table--header">
                                      <div class="column--one">
                                        Medical [Hospitalisation & Surgical]
                                      </div>
                                      <div class="column--two">RM</div>
                                    </div>
                                    <table class="insurance-table table-medical">
                                      <tbody>
                                        <tr>
                                          <th class="big--heading">
                                            <i>Hospital Expenses</i>
                                          </th>
                                          <th class="blank--heading"></th>
                                          <th class="rm--heading"></th>
                                        </tr>
                                        <tr>
                                          <td
                                            data-th="Hospital Expenses"
                                            class="feature"
                                          >
                                            Hospital Room & Board
                                          </td>
                                    ...
                                    <table class="insurance-table table-medical">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td
                                            data-th="Operating Theatre Fees"
                                            class="feature"
                                          >
                                    ...
                                    <table class="insurance-table table1 table-medical">
                                      <tbody>
                                        <tr>
                                          <th class="big--heading">
                                            Lifestyle Insurance
                                        ...
                                        <tr>
                                          <td
                                            ...
                                            class="feature"
                                          >
                                            Snatch theft or attempted snatch
                                            theft
                                          </td>
                                          <td data-th="Upto" class="upto">
                                            Up to
                                    ...
                                    <table class="insurance-table table2 table-medical">
                                      <tbody>
                                        <tr>
                                          <th class="big--heading">
                                            Home Care Insurance
                                        ...
                                        <tr>
                                          ...
                                          <td data-th="Upto" class="upto"></td>
                                          <td data-th="RM" class="rm"></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    <table class="insurance-table table3 table-medical">
                                      <tbody>
                                        <tr>
                                          <th class="big--heading">
                              ...
                              <Accordion.Body>
                                <div class="accordion-body">
                                  <table class="insurance-table insurance-tablev2">
                                    <tbody>
                                      <tr>
                                        <td class="feature blank--colspan"></td>
                                        <td data-th="RM" class="rm">
                                          DIGI
                                        </td>
                                        <td data-th="RM" class="rm">
